              ...
              <div className="max-w-md">
                <div className="flex items-center gap-4">
                  ...
                  <button 
                    ...
                    className="bg-[#8795A1] hover:bg-[#73828f] text-white text-sm font-medium py-2.5 px-8 rounded-lg transition-all shadow-md flex items-center gap-2"
                  >
            ...
            <form onSubmit={handlePasswordChange} className="space-y-6">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-slate-50 border border-slate-100 py-3 px-4 rounded-xl text-slate-700 font-bold focus:outline-none focus:ring-4 focus:ring-green-500/10 focus:bg-white focus:border-green-500 transition-all"
                  placeholder="••••••••"
                />
              </div>
              ...
              <div className="flex gap-4 pt-2">
                <button 
                  type="submit"
                  disabled={isUpdating}
                  className="flex-1 bg-[#5CB85C] hover:bg-[#4AA14A] text-white py-3.5 rounded-xl font-bold transition-all shadow-lg shadow-green-100 flex items-center justify-center gap-2"
                >
