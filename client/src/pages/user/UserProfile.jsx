        ...
        <UserPageContainer isMobile={isMobile}>
            ...
            <div className="bg-white rounded-[32px] p-8 md:p-12 shadow-sm border border-slate-100 flex flex-col md:flex-row gap-12 min-h-[500px]">
                ...
                <div className="flex-1 space-y-10">
                    ...
                    {/* Link Socials */}
                    <div className="space-y-4">
                        <h3 className="text-lg font-bold text-slate-700">Link your google account</h3>
                        <div className="flex gap-4">
                            <div onClick={() => toast.success("Google integration coming soon!")} className="p-2 cursor-pointer transition-transform hover:scale-110">
                            ...
                            <div onClick={() => toast.success("LinkedIn integration coming soon!")} className="p-2 cursor-pointer transition-transform hover:scale-110">
                            ...
                            <div onClick={() => toast.success("Discord integration coming soon!")} className="p-2 cursor-pointer transition-transform hover:scale-110">
                            ...
                            <div onClick={() => toast.success("Facebook integration coming soon!")} className="p-2 cursor-pointer transition-transform hover:scale-110">
